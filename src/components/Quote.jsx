export default function Quote() {
  return (
    <section className="  gap-8 bg-[var(--bg-colour-purple)] h-auto py-10 px-5 md:py-40 flex flex-col justify-center items-center text-white text-al text-center  text-xl md:text-3xl">
